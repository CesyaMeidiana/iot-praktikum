...
@section('content')
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div class="flex gap-2 px-6 pt-6 border-b border-slate-100 pb-4">
            <a href="{{ route('dosen.notifications.page') }}"
            ...
            <a href="{{ route('dosen.notifications.page', ['filter' => 'unread']) }}"
            ...
            <a href="{{ route('dosen.notifications.page', ['filter' => 'read']) }}"
        ...
        <div class="divide-y divide-slate-100">
            @forelse($notifications as $n)
                <a href="{{ route('dosen.notifications.open', $n->id) }}"
