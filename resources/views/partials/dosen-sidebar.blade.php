        ...
        <ul class="space-y-3">
            ...
            <li>
                <a href="{{ route('dosen.dashboard') }}"
                   ...
                   {{ request()->routeIs('dosen.dashboard') ? 'bg-blue-600 shadow-lg' : 'hover:bg-slate-800' }}">
            ...
            <li>
                <a href="{{ route('dosen.classrooms.index') }}"
                   class="flex items-center gap-4 px-4 py-3 rounded-xl transition
                   {{ request()->routeIs('dosen.classrooms.*') ? 'bg-blue-600 shadow-lg' : 'hover:bg-slate-800' }}">
            ...
            <li>
                <a href="{{ route('dosen.devices.index') }}"
                   class="flex items-center gap-4 px-4 py-3 rounded-xl transition
                   {{ request()->routeIs('dosen.devices.*') ? 'bg-blue-600 shadow-lg' : 'hover:bg-slate-800' }}">
            ...
            <li>
                <a href="{{ route('dosen.riwayat.index') }}"
                   class="flex items-center gap-4 px-4 py-3 rounded-xl transition
                   {{ request()->routeIs('dosen.riwayat.*') ? 'bg-blue-600 shadow-lg' : 'hover:bg-slate-800' }}">
            ...
            <li>
                <a href="{{ route('dosen.tugas.index') }}"
                   class="flex items-center gap-4 px-4 py-3 rounded-xl transition
                   {{ request()->routeIs('dosen.tugas.*') ? 'bg-blue-600 shadow-lg' : 'hover:bg-slate-800' }}">
