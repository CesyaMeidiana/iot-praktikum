    ...
    <div class="flex-1 flex flex-col px-5 py-6">
        ...
        <ul class="space-y-3">
            ...
            <li>
                ...
                <a href="{{ route('mahasiswa.dashboard') }}"
                   class="flex items-center gap-4 px-4 py-3 rounded-xl transition
                    {{ request()->routeIs('mahasiswa.dashboard') ? 'bg-blue-600 shadow-lg' : 'hover:bg-slate-800' }}"
            ...
            <li>
                ...
                <a href="{{ route('mahasiswa.praktikum.active') }}"
                   class="flex items-center gap-4 px-4 py-3 rounded-xl transition
                    {{ request()->routeIs('mahasiswa.praktikum.*') ? 'bg-blue-600 shadow-lg' : 'hover:bg-slate-800' }}
            ...
            <li>
                ...
                <a href="{{ route('mahasiswa.tugas.index') }}"
                   class="flex items-center gap-4 px-4 py-3 rounded-xl transition
                   {{ request()->routeIs('mahasiswa.tugas.*') ? 'bg-blue-600 shadow-lg' : 'hover:bg-slate-800' }}
            ...
            <li>
                ...
                <a href="{{ route('mahasiswa.profile') }}"
                 class="flex items-center gap-4 px-4 py-3 rounded-xl transition
                 {{ request()->routeIs('mahasiswa.profile') ? 'bg-blue-600 shadow-lg' : 'hover:bg-slate-800' }}
